...
public interface ProtocolGenerator {
    ...
    default Symbol getSerializationFunction(GenerationContext context, ToShapeId shapeId) {
        return Symbol.builder()
                ...
                .namespace(format("%s.serialize", CaseUtils.toSnakeCase(context.settings().getService().getNamespace())), "")
                .definitionFile(format("./%s/serialize.py", CaseUtils.toSnakeCase(context.settings().getService().getNamespace())))
                .build();
    }
    ...
    default Symbol getErrorDeserializationFunction(GenerationContext context, ToShapeId shapeId) {
        ...
        return Symbol.builder()
            ...
            .namespace(format("%s.deserialize", CaseUtils.toSnakeCase(context.settings().getService().getNamespace())), "")
            .definitionFile(format("./%s/deserialize.py", CaseUtils.toSnakeCase(context.settings().getService().getNamespace())))
            .build();
    }
